	...
	<nav class="tm-navbar uk-navbar uk-navbar-attached">
            <div class="uk-container uk-container-center">
		        ...
		        <!--        <a href="#tm-offcanvas" class="uk-navbar-toggle uk-visible-small" data-uk-offcanvas></a>-->
		                ...
		                <div class="uk-navbar-brand uk-navbar-center uk-visible-small"><img src="images/logo.png" width="90" height="30" title="UIkit" alt="UIkit"></div>
	               	</div>
		...
		<div class="uk-grid" data-uk-grid-margin>
			<div class="uk-vertical-align uk-text-center" style="background: url('data:image/svg+xml;base64,') 50% 0 no-repeat; height: 450px;">
                <div class="uk-vertical-align-middle uk-width-1-2">
                    <h1 class="uk-heading-large">Carousel comes here</h1>
